...
Namespace Classes
    Public Module SettingsManager
        ...
        Dim ConfigFilePath As String = IO.Path.Combine(My.Computer.FileSystem.SpecialDirectories.CurrentUserApplicationData, "Devil7-Softwares", "Feedbacks Manager", "Settings.config")
